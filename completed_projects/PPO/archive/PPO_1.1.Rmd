...
```{r import_data}
data_file_path <- ("data_/WerktuigPPO |  FebMar")
...
```{r}
wordcloud(words = words$word, freq = words$n, min.freq = 1, max.words = 200, random.order = TRUE, rot.per=0.45, colors = brewer.pal(8, "Dark2"))
```
